...
//	float newAngle = (GLfloat)DEGREES_TO_RADIANS((360.0 / maxParticles) * particleCount);
...
- (void)emit:(int) aEmitCount {
	...
	while(particleCount < maxParticles && newEmitCount++ < aEmitCount) {
		[self addParticle];
	}		
}
